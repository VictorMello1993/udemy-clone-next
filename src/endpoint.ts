...
type Handler<T> = (req: NextApiRequest, res: NextApiResponse) => Promise<[HTTPStatus, T]> | [HTTPStatus, T];

type Endpoint<GetData extends EndpointData, PostData extends EndpointData, PutData extends EndpointData, PatchData extends EndpointData, DeleteData extends EndpointData> = {
  get?: Handler<GetData>;
